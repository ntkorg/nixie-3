...
fn set_resource_limit_value_raw(
...
pub fn set_max_physical_memory_limit_value(
  handle: Handle<ResourceLimit>,
  limit_value: u64,
) -> Result<(), ResultCode> {
...
pub fn set_max_thread_count_limit_value(
  handle: Handle<ResourceLimit>,
  limit_value: u64,
) -> Result<(), ResultCode> {
...
pub fn set_max_event_count_limit_value(
  handle: Handle<ResourceLimit>,
  limit_value: u64,
) -> Result<(), ResultCode> {
...
pub fn set_max_transfer_memory_count_limit_value(
  handle: Handle<ResourceLimit>,
  limit_value: u64,
) -> Result<(), ResultCode> {
...
pub fn set_max_session_count_limit_value(
  handle: Handle<ResourceLimit>,
  limit_value: u64,
) -> Result<(), ResultCode> {
