...
impl<const IN_WIDTH: usize, const OUT_WIDTH: usize> From<&'static [u8; IN_WIDTH]> for Magic<OUT_WIDTH> where [u8; OUT_WIDTH - IN_WIDTH]: Sized {
...
pub fn reverse_magic<const IN_WIDTH: usize, const OUT_WIDTH: usize>(magic: &'static [u8; IN_WIDTH]) -> Magic<OUT_WIDTH> where [u8; OUT_WIDTH - IN_WIDTH]: Sized {
